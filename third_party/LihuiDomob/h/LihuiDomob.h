 ...
 */
#ifndef S3E_EXT_LIHUIDOMOB_H
#define S3E_EXT_LIHUIDOMOB_H
...
/**
 * Returns S3E_TRUE if the LihuiDomob extension is available.
 */
 ...
 *
 * The available callback types are listed in @ref LihuiDomobCallback.
 ...
 *
 * @see LihuiDomobUnRegister
 * @note For more information on the system data passed as a parameter to the callback
 * registered using this function, see the @ref LihuiDomobCallback enum.
 */
 ...
 * registered using this function, see the LihuiDomobCallback enum.
 * @note It is not necessary to define a return value for any registered callback.
 * @see LihuiDomobRegister
 */
