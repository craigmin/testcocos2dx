...
bool LeaderBoard::init()
{
	...
	CCSprite* updateNicknamelb = CCSprite::spriteWithFile("images/btn_update_nickname.png");
	CCSprite* updateNicknameSelectedlb = CCSprite::spriteWithFile("images/btn_update_nickname.png");
	CCSprite* updateNicknameDisabledlb = CCSprite::spriteWithFile("images/btn_update_nickname.png");
